...
import { Button, Text, View, TextInput, CheckBox, ScrollView } from "react-native";
...
function TestScreen({ navigation }) {
    ...
    return (
        ...
        <ScrollView style={styles.loginScreenContainer}>
            <Text style={{ marginLeft: 50, marginBottom: 20, fontSize: 20 }}>Répender aux questions suivant :  </Text>
            <View style={{ justifyContent: "center", marginLeft: 20, marginBottom: 10 }}>
                ...
                <View style={{ flexDirection: "row" }}>
                    <CheckBox
                        ...
                        style={{ alignSelf: "center", }}
                    />
                    <Text style={{ margin: 8, }} >Oui. et le résultat du test est négatif.</Text>
                </View>
                <View style={{ flexDirection: "row" }}>
                    <CheckBox
                        value={isSelected}
                        ...
                        style={{ alignSelf: "center", }}
                    />
                    <Text style={{ margin: 8, }} >Oui et en attente du résultat du test</Text>
                </View>
                <View style={{ flexDirection: "row" }}>
                    <CheckBox
                        value={isSelected}
                        ...
                        style={{ alignSelf: "center", }}
                    />
                    <Text style={{ margin: 8, }} >Oui. et le résultat du test est positif.</Text>
                </View> */
    // </View>
    /* <View style={{ justifyContent: "center", marginLeft: 20, marginBottom: 10 }}>
<Text>Q2 : En ce qui concerne l'isolement médical. lequel des éléments suivants s'applique à vous: </Text>
<View style={{ flexDirection: "row" }}>
    <CheckBox
        value={isSelected}
        onValueChange={setSelection}
        style={{ alignSelf: "center", }}
    />
    <Text style={{ margin: 8, }} >Je suis en isolement médical parce que j'ai
    rencontré une personne contaminée.</Text>
</View>
<View style={{ flexDirection: "row" }}>
    <CheckBox
        value={isSelected}
        ...
        style={{ alignSelf: "center", }}
    />
    <Text style={{ margin: 8, }} >Je suis en isolement médical parce que j'ai des symptômes.</Text>
</View>
<View style={{ flexDirection: "row" }}>
    <CheckBox
        value={isSelected}
        ...
        style={{ alignSelf: "center", }}
    />
    <Text style={{ margin: 8, }} >Je ne suis pas en isolement médical mais j'étais proche de quelqu'un en isolement médical</Text>
</View>
<View style={{ flexDirection: "row" }}>
    <CheckBox
        value={isSelected}
...
<View style={{ justifyContent: "center", marginLeft: 20, marginBottom: 10 }}>
<Text>Q3 : -Avez-vous actuellement ou avez-vous déjà vécu l'une des situations suivantes: </Text>
<View style={{ flexDirection: "row" }}>
    <CheckBox
        value={isSelected}
        onValueChange={setSelection}
...
<View style={{ justifyContent: "center", marginLeft: 20, marginBottom: 10 }}>
<Text>Q4 : Avez-vous eu les symptômes suivants aujourd'hui?.Veuillez les cocher si c'est le cas :</Text>
<View style={{ flexDirection: "row" }}>
    <CheckBox
        value={isSelected}
        onValueChange={setSelection}
...
<View style={{ justifyContent: "center", marginLeft: 20, marginBottom: 10 }}>
 ...
 <TextInput autoCapitalize='none' onChangeText={text => setRep(text)} placeholderColor="#c4c3cb" style={styles.InfoFormTextInput} />
</View>
...
<View>
 <Button type="outline" title="Return to dashboard" onPress={() => ReturnTo()} />
